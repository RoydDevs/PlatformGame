...
public class ShopManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (instance != null)
        {
            Debug.LogWarning("There is more than 1 instance of ShopManager in the scene");
        }
    ...
    void UpdateItemsToSell(Item[] items)
	{
        ...
        //Instantiate all items in the shop
		for (int i = 0; i < items.Length; i++)
		{
            ...
            //Add in onClick of the button a listener to use the method BuyItem()
